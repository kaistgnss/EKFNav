...
enum BINARY_LOG_TYPE
{
  ...
  GALIONOB_LOG_TYPE = 1127,
  DUALANTENNAHEADING_LOG_TYPE = 2042,
  PDPXYZB_LOG_TYPE = 471,
...
enum SIGNAL_TYPE_GPS{
	GPS_L1CA 					= 0,
	GPS_L2P 					= 5,
	GPS_L2P_SEMI_CODELESS 	= 9,
	GPS_L5 					= 14,
	GPS_L1C_P 					= 16,
	GPS_L2C_M 					= 17
};

enum SIGNAL_TYPE_GLO{
	GLO_L1CA 		= 0,
	GLO_L2CA 		= 1,
	GLO_L2P 		= 5,
	GLO_L3_Q 		= 6
