...
typedef struct __mavlink_ladgnss_common_t {
 ...
 int32_t reference_point_height; /*< Reference point height */
 uint16_t modified_z_count; /*< Modified Z-count */
 uint8_t additional_msg_flag; /*< Additional message flag */
 uint8_t n_measurements; /*< Number of measurements */
 uint8_t measurement_type; /*< Measurement type */
...
#define MAVLINK_MSG_ID_LADGNSS_COMMON_LEN 30
#define MAVLINK_MSG_ID_LADGNSS_COMMON_MIN_LEN 30
#define MAVLINK_MSG_ID_1_LEN 30
#define MAVLINK_MSG_ID_1_MIN_LEN 30

#define MAVLINK_MSG_ID_LADGNSS_COMMON_CRC 203
#define MAVLINK_MSG_ID_1_CRC 203
...
#define MAVLINK_MESSAGE_INFO_LADGNSS_COMMON { \
    ...
    "LADGNSS_COMMON", \
    14, \
    {  { "eph_decorrelation_parama", NULL, MAVLINK_TYPE_FLOAT, 0, 0, offsetof(mavlink_ladgnss_common_t, eph_decorrelation_parama) }, \
         { "sigma_vert_iono_gradient", NULL, MAVLINK_TYPE_FLOAT, 0, 4, offsetof(mavlink_ladgnss_common_t, sigma_vert_iono_gradient) }, \
         { "latitude", NULL, MAVLINK_TYPE_INT32_T, 0, 8, offsetof(mavlink_ladgnss_common_t, latitude) }, \
         { "longitude", NULL, MAVLINK_TYPE_INT32_T, 0, 12, offsetof(mavlink_ladgnss_common_t, longitude) }, \
         { "reference_point_height", NULL, MAVLINK_TYPE_INT32_T, 0, 16, offsetof(mavlink_ladgnss_common_t, reference_point_height) }, \
         { "modified_z_count", NULL, MAVLINK_TYPE_UINT16_T, 0, 20, offsetof(mavlink_ladgnss_common_t, modified_z_count) }, \
         { "additional_msg_flag", NULL, MAVLINK_TYPE_UINT8_T, 0, 22, offsetof(mavlink_ladgnss_common_t, additional_msg_flag) }, \
         { "n_measurements", NULL, MAVLINK_TYPE_UINT8_T, 0, 23, offsetof(mavlink_ladgnss_common_t, n_measurements) }, \
         { "measurement_type", NULL, MAVLINK_TYPE_UINT8_T, 0, 24, offsetof(mavlink_ladgnss_common_t, measurement_type) }, \
         { "eph_crc", NULL, MAVLINK_TYPE_UINT8_T, 0, 25, offsetof(mavlink_ladgnss_common_t, eph_crc) }, \
         { "source_availability_duration", NULL, MAVLINK_TYPE_UINT8_T, 0, 26, offsetof(mavlink_ladgnss_common_t, source_availability_duration) }, \
         { "refrectivity_index", NULL, MAVLINK_TYPE_UINT8_T, 0, 27, offsetof(mavlink_ladgnss_common_t, refrectivity_index) }, \
         { "scale_height", NULL, MAVLINK_TYPE_UINT8_T, 0, 28, offsetof(mavlink_ladgnss_common_t, scale_height) }, \
         { "refrectivity_uncertainty", NULL, MAVLINK_TYPE_UINT8_T, 0, 29, offsetof(mavlink_ladgnss_common_t, refrectivity_uncertainty) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_LADGNSS_COMMON { \
 ...
 *
 * @param modified_z_count Modified Z-count 
 * @param additional_msg_flag Additional message flag 
...
static inline uint16_t mavlink_msg_ladgnss_common_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               uint16_t modified_z_count, uint8_t additional_msg_flag, uint8_t n_measurements, uint8_t measurement_type, float eph_decorrelation_parama, uint8_t eph_crc, uint8_t source_availability_duration, float sigma_vert_iono_gradient, uint8_t refrectivity_index, uint8_t scale_height, uint8_t refrectivity_uncertainty, int32_t latitude, int32_t longitude, int32_t reference_point_height)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_LADGNSS_COMMON_LEN];
    _mav_put_float(buf, 0, eph_decorrelation_parama);
    _mav_put_float(buf, 4, sigma_vert_iono_gradient);
    _mav_put_int32_t(buf, 8, latitude);
    _mav_put_int32_t(buf, 12, longitude);
    _mav_put_int32_t(buf, 16, reference_point_height);
    _mav_put_uint16_t(buf, 20, modified_z_count);
    _mav_put_uint8_t(buf, 22, additional_msg_flag);
    _mav_put_uint8_t(buf, 23, n_measurements);
    _mav_put_uint8_t(buf, 24, measurement_type);
    _mav_put_uint8_t(buf, 25, eph_crc);
    _mav_put_uint8_t(buf, 26, source_availability_duration);
    _mav_put_uint8_t(buf, 27, refrectivity_index);
    _mav_put_uint8_t(buf, 28, scale_height);
    _mav_put_uint8_t(buf, 29, refrectivity_uncertainty);
...
static inline void mavlink_msg_ladgnss_common_send(mavlink_channel_t chan, uint16_t modified_z_count, uint8_t additional_msg_flag, uint8_t n_measurements, uint8_t measurement_type, float eph_decorrelation_parama, uint8_t eph_crc, uint8_t source_availability_duration, float sigma_vert_iono_gradient, uint8_t refrectivity_index, uint8_t scale_height, uint8_t refrectivity_uncertainty, int32_t latitude, int32_t longitude, int32_t reference_point_height)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_LADGNSS_COMMON_LEN];
    _mav_put_float(buf, 0, eph_decorrelation_parama);
 ...
 */
static inline void mavlink_msg_ladgnss_common_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint16_t modified_z_count, uint8_t additional_msg_flag, uint8_t n_measurements, uint8_t measurement_type, float eph_decorrelation_parama, uint8_t eph_crc, uint8_t source_availability_duration, float sigma_vert_iono_gradient, uint8_t refrectivity_index, uint8_t scale_height, uint8_t refrectivity_uncertainty, int32_t latitude, int32_t longitude, int32_t reference_point_height)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
 ...
 */
static inline uint16_t mavlink_msg_ladgnss_common_get_modified_z_count(const mavlink_message_t* msg)
{
 ...
 *
 * @return Additional message flag 
 */
 ...
 * @return Latitude
 */
static inline int32_t mavlink_msg_ladgnss_common_get_latitude(const mavlink_message_t* msg)
{
 ...
 * @return Longitude
 */
static inline int32_t mavlink_msg_ladgnss_common_get_longitude(const mavlink_message_t* msg)
{
 ...
 */
static inline int32_t mavlink_msg_ladgnss_common_get_reference_point_height(const mavlink_message_t* msg)
{
