...
#define MAVLINK_MESSAGE_INFO_LADGNSS_MEASUREMENT_BLOCK { \
    ...
    {  { "prc_100s", NULL, MAVLINK_TYPE_INT16_T, 0, 0, offsetof(mavlink_ladgnss_measurement_block_t, prc_100s) }, \
         ...
         { "iod", NULL, MAVLINK_TYPE_UINT8_T, 0, 9, offsetof(mavlink_ladgnss_measurement_block_t, iod) }, \
...
static inline uint16_t mavlink_msg_ladgnss_measurement_block_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               uint8_t ranging_source_id, uint8_t iod, int16_t prc_100s, int16_t rrc_100s, int16_t prc_30s, int16_t rrc_30s, uint8_t sigma_pr_gnd_100s, uint8_t sigma_pr_gnd_30s, int8_t b1, int8_t b2, int8_t b3, int8_t b4)
{
...
static inline void mavlink_msg_ladgnss_measurement_block_send(mavlink_channel_t chan, uint8_t ranging_source_id, uint8_t iod, int16_t prc_100s, int16_t rrc_100s, int16_t prc_30s, int16_t rrc_30s, uint8_t sigma_pr_gnd_100s, uint8_t sigma_pr_gnd_30s, int8_t b1, int8_t b2, int8_t b3, int8_t b4)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_LADGNSS_MEASUREMENT_BLOCK_LEN];
    _mav_put_int16_t(buf, 0, prc_100s);
 ...
 */
static inline void mavlink_msg_ladgnss_measurement_block_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint8_t ranging_source_id, uint8_t iod, int16_t prc_100s, int16_t rrc_100s, int16_t prc_30s, int16_t rrc_30s, uint8_t sigma_pr_gnd_100s, uint8_t sigma_pr_gnd_30s, int8_t b1, int8_t b2, int8_t b3, int8_t b4)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
 ...
 */
static inline uint8_t mavlink_msg_ladgnss_measurement_block_get_iod(const mavlink_message_t* msg)
{
